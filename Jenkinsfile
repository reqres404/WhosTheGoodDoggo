pipeline {
    ...
    stages {
        ...
        stage('Run Containers') {
            steps {
                sh 'docker run -d -p 127.0.0.1:4000:4000 -e DB_URL=$DB_URL -e CLOUDINARY_CLOUD_NAME=$CLOUDINARY_CLOUD_NAME -e CLOUDINARY_API_KEY=$CLOUDINARY_API_KEY -e CLOUDINARY_SECRET_KEY=$CLOUDINARY_SECRET_KEY -e CLOUDINARY_ENV_VAR=$CLOUDINARY_ENV_VAR -e CLOUDINARY_URL=$CLOUDINARY_URL adittyapatil1818/wgd_jenkins:server'
